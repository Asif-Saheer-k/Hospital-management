...
const { registerUser,verifyUser,verifyPhone,verifyotp,viewDepartmetDoctor,addPatient,viewUserAppointment,deleteAppointment } = require("../controllers/userControllers");
